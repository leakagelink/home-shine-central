    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-xl border border-input bg-card px-5 py-2.5 text-sm font-semibold text-foreground"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SqueakClean — Home Cleaning, Booked in Minutes" },
      {
        ...
        content: "Bathroom, kitchen, flat and add-on cleaning with verified professionals.",
      },
